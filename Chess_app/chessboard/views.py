...
def move_generator(request):
    ...
    '''
    Here I will insert the code to filter through the database and get the best move.
    At which point, we can merely change the "b3" in the below code to the desired
    move that was outputted. After that, the code is entirely done.
    '''
